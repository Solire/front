...
$.widget("ui.form",{
    _init:function(){
        ...
        var inputs = form.find('input[type!=hidden] , select:not(.multiselect, .ui-select) ,textarea');
...
//                object.buttons(this);
    ...
    checkboxes:function(element){
        ...
        parent.parent("span").click(function(event, data){
            $(this).toggleClass("ui-state-active");
            parent.toggleClass("ui-icon ui-icon-check");
            if(typeof(data) == "undefined" ||  !data.noclick_element)
                $(element).click();
					
        });
        
        if($(element).is(":checked"))
            parent.parent("span").trigger("click", {
                noclick_element : true
            });
    ...
    selector:function(element){
        ...
        $(parent).next("ul").find("li").click(function(){
            $("#labeltext", parent).html($(this).html());
        ...
        $("#labeltext", parent).html($('option:selected', element).html());
